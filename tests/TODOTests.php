...
//     write_mock_file('example.json', <<<'EOL'
//     {
//         "name": "{{ $name }}",
...
//     $contents = testBlade()->compile(test_mock_path('example.json'), [
//         'name' => 'Bob',
//         'favoriteFood' => 'Pizza',
//         'includeAddress' => true,
//     ]);
...
//     // nested example:
//     $includePath = test_mock_path('include2.yaml');
...
//     @include('$includePath')
//     EOL);
//     write_mock_file('include2.yaml', <<<'EOL'
//     contact_info:
//         phone: 1234567890
//         @if($includeAddress)
//         street_info: 123 Lane.
